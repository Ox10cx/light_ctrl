...
public class ClipImageView extends ImageView implements
    ...
    public ClipImageView(Context context, AttributeSet attrs) {
        ...
        mClipPadding = ta.getDimensionPixelSize(R.styleable.ClipImageView_civClipPadding,1000);
    ...
    public void drawRectangleOrCircle(Canvas canvas) {
        ...
        if (mDrawCircleFlag) { // 画圆
            ...
            Log.d(TAG,"drawCircle 圆心x"+cx);
            Log.d(TAG,"drawCircle 圆心y"+cy);
            Log.d(TAG,"drawCircle 半径"+radius);
